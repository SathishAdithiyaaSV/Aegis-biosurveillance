...
import { BeakerIcon, CircleStackIcon } from '@heroicons/react/24/solid';
...
const EnvironmentalPanel: React.FC<EnvironmentalPanelProps> = ({ alerts, onAlertClick, dataSource, dataSourceTooltip, onViewLayer }) => {
