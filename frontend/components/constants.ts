...
import { Kpi, TimeSeriesData, StateData, Alert, Threat, HumanHealthData, ZoonoticAlert, EnvironmentalAlert, WildlifeAlert, DisasterAlert, VaccineInventoryItem, GenomicSignal, BioThreat, LabStatus, NationalBiosecurityIndexData, RiskLevel, BiologicalWeaponSignal, ChemicalWeaponSignal, LivestockAlert, SlaughterhouseData } from '../types';
...
// FIX: Added missing livestockAlertsIndia constant.
...
export const oneHealthIndexDataIndia = {
  ...
  // FIX: Added missing livestock property to the exported object.
...
export const nationalLabNetworkStatusIndia: LabStatus[] = [
    ...
    // FIX: Changed status 'Engaged' to 'High-Alert' to match the LabStatus type definition.
